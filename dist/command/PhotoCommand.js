...
async function processPhotoSet(userId, photos, msgs) {
    ...
    try {
        await (0, CreateTask_1.createTaskService)(firstMsg?.caption || "", chatId, userId, photos);
        ...
        if (chatId) {
            await config_1.telegram.sendMessage(chatId, "❌ Error creating task. Please try again.");
        }
    }
}
...
exports.default = onPhotoCommandHandler;
